...
O `v4l-utils` é um conjunto de ferramentas para gerenciar, configurar e depurar dispositivos de vídeo no `Linux` que utilizam a _interface_ `Video4Linux2 (V4L2)`.
...
| `v4l2-compliance` | Testar se o _driver_ segue o padrão `V4L2` |
| `v4l2-dbg`        | Debug avançado                             |
| `media-ctl`       | Gerenciar _pipeline_ de mídia              |
